...
import poultryImg from '../../assets/images/poultry-img1.jpg';
import starIcon from '../../assets/images/Star.png';
import DiseaseAbout from './DiseaseAbout';
                    ...
                    <div className="md:col-span-2">
                        <div className="flex items-center gap-5">
                            <figure className="max-w-[200px] max-h-[200px]">
                                <img src={poultryImg} alt="" className="w-full" />
                            </figure>
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-[6px]">
                                    ...
                                    lg:leading-7 font-semibold text-headingColor">
                                        <img src={starIcon} alt="" /> --{/* Update with appropriate rating */}
                                    </span>
                                    <span className="flex items-center gap-[6px] text-[14px] leading-5 lg:text-[16px] 
                                    lg:leading-7 font-[400] text-textColor">
                                        (--){/* Update with appropriate rating count */}
                                    </span>
                                </div>

                                <p className="text__para text-[14px] leading-6 md:text-[15px] max-w-[390px]">
                                    Explore in-depth details about poultry disease detection, ensuring the health and well-being 
                                    of your flock with our advanced system.
                                </p>
                            </div>
